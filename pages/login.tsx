...
const Login = () => {
  ...
  return (
    <div className="h-screen w-screen relative">
      ...
      <Image
        className="opacity-70 invisible md:visible"
        src={
          "https://i.pinimg.com/originals/6b/e7/4c/6be74cf2eb1c6873c0183fcd8abf9d0f.jpg"
        }
        fill={true}
        alt="login bg"
      ...
      <div className="relative">
        <svg
          className="ml-4 my-5 md:absolute md:top-10 md:left-10"
          viewBox="0 0 700 30"
        >
          <path
            className="fill-[#e50914] h-10"
